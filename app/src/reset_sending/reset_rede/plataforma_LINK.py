...
def main(session, recipient, logger):
    ...
    base_url = 'https://lsm.tnsi.com.br'
    auth_url = f'{base_url}/api/authenticate'
    bearer_token = None

    try:
        # 1. Autenticar para obter o Token Bearer
        auth_payload = {'username': 'gerencia@globalsystem24h.com', 'password': 'Gs98375656#'}
        ...
        headers_reset = {
            ...
            "host": "lsm.tnsi.com.br",
            "referer": "https://lsm.tnsi.com.br/",
        ...
        response_reset = session.post(f'https://lsm.tnsi.com.br/api/outside?cacheBuster={cache_buster_reset}&action=reset&key=msisdn', json=reset_data, headers=headers_reset)
